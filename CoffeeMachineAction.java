...
public class CoffeeMachineAction {
    ...
    //Not enough coffee ingredients
    public  static boolean isOutResources(int water, int milk, int beans, int cups, String option) {
        if (cups - 1 < 0) {
            ...
            switch (action) {
                case "buy":
                    ...
                    if (buyOption.equals("1") || buyOption.equals("2") || buyOption.equals("3")) {
                        if (isOutResources(water,milk,beans,cups,buyOption)) {
                            break;
                        } else {
